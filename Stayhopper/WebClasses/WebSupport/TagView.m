...
//  TagView.m
//
//  Created by UGO Technologies on 15/03/2016.
//  Copyright (c) 2017 UGO Technologies. All rights reserved.
//
...
- (UIFont *)textFont {
    if(!self.textFont) {
        self.textFont = [UIFont fontWithName:@"HelveticaNeue-Thin" size:6.0f];;
    }
