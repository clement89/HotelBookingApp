...
- (void)commonInit {
    ...
    _contentColor = isLegacy ? [UIColor blueColor] : [UIColor colorWithWhite:0.f alpha:0.7f];
...
- (void)setupViews {
    ...
    backgroundView.backgroundColor = [UIColor clearColor];//[[UIColor alloc] initWithWhite:0.f alpha:0.4f];CJC commented
    ...
    UIImageView* spinnerImageView=[UIImageView new];
    spinnerImageView.frame=CGRectMake(0, 0, 220, 220);
    spinnerImageView.backgroundColor=[UIColor clearColor];
    spinnerImageView.animationDuration=1.0f;//CJC changed from 4
...
//        [imageArray addObject:[UIImage imageNamed:[NSString stringWithFormat:@"loader%d.png",i]]];
        
        [imageArray addObject:[UIImage imageNamed:[NSString stringWithFormat:@"frame-%d.png",i]]];

        
    }
    spinnerImageView.animationImages=imageArray;
    
    [spinnerImageView startAnimating];
  //  spinnerImageView.clipsToBounds=YES;
   // spinnerImageView.layer.cornerRadius=50;
    
    spinnerImageView.contentMode=UIViewContentModeScaleAspectFill;
    spinnerImageView.center=_backgroundView.center;
    [_backgroundView addSubview:spinnerImageView];
